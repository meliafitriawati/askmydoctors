  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      <div class="row">
          ...
          <a class="btn btn-block btn-primary" href="<?=base_url()?>admin/tambah/dokter"><i class="fa fa-plus"></i> Tambah</a>
      	</div>
      </div>
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Daftar Dokter Terdaftar</h3>
