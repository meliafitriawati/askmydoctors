...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Ask My Doctors | Dokter</title>
                                              ...
                                              if ($dokter != null) {
                                                foreach ($dokter as $key) {
                                                  echo "<tr>
                                                    ...
                                                    <td><img style='width:70px' src='".base_url(). "assets/img/dokter/".$key->image."'></td>
                                                    <td>".$key->tgl_daftar."</td>
                                                    <td>";
                                                    echo '<span class="btn btn-info btn-xs btn-edit" ref="'.$key->username.'"><i class="fa fa-edit"></i></span> ';
                    ...
                    <div class="modal-dialog">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h4 class="modal-title">Dokter Baru</h4>
                            </div>
                            <div class="modal-body">
                                <form class="form-horizontal">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                          <label for="inputSpesialisasi" class="col-sm-2 control-label">Spesialisasi</label>
                                          <div class="col-sm-10">
                                            <select class="form-control" id="inputSpesialisasi" name="inputSpesialisasi" required="required">
                                              <?php
                                                $this->load->model('madmin');
                                                $spesialisasi = $this->madmin->getAllSpesialisasi();
                            ...
                            <div class="modal-body">
                                <form class="form-horizontal">
                                    <div class="box-body">
                                        ...
                                        <div class="form-group">
                                          <label for="inputEditSpesialisasi" class="col-sm-2 control-label">Spesialisasi</label>
                                          <div class="col-sm-10">
                                            <select class="form-control" id="inputEditSpesialisasi" name="inputEditSpesialisasi" required="required">
                                              <?php
                                                $this->load->model('madmin');
                                                $spesialisasi = $this->madmin->getAllSpesialisasi();
                                                if ($spesialisasi != null) {
...
$(function () {
        ...
        $(document).on('click', '.btn-delete', function () {
            ...
            $.ajax({
                async: true,
                type: 'post',
                url: '<?= base_url(); ?>admin/deleteDokter',
                data: 'username=' + username,
                dataType: 'json',
                success: function (resp) {
                    if (resp.code == 200) {
                        $.bootstrapGrowl("Berhasil menghapus dokter!", {type: 'success'});
                        location.reload();
                    } else {
                        $.bootstrapGrowl("Gagal menghapus dokter", {type: 'danger'});
                    }
                }
            });
        });
