    ...
    <section class="content">
      <div class="row">
      	<div style="margin-bottom: 15px;" class="col-md-2">
      		<a class="btn btn-block btn-primary" href="<?=base_url()?>admin/tambah/spesialisasi"><i class="fa fa-plus"></i> Spesialisasi</a>
      	</div>
      </div>
      <div class="row">
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Daftar Spesialisasi</h3>
