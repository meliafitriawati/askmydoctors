  ...
  <div class="clearfix">
    ...
    <div class="col-sm-12 col-xs-12 login wowload fadeInLeft">
        ...
        <div class="login-box-body" style="border: 1px solid #73c3eb; box-shadow: 2px 2px 2px #888888;">
          <p class="login-box-msg"><b>LOGIN DOKTER</b></p>

          <form action="<?=base_url()?>login/dologin/dokter" method="post">
         ...
         <!--  <div class="social-auth-links text-center">
          ...
          <!-- /.social-auth-links -->
          <a href="<?=base_url()?>login" style="line-height: 34px;">Login Sebagai Pasien!</a><br>
        </div>
        <!-- /.login-box-body -->
      </div>
    </div>
