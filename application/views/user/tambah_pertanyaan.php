    ...
    <div class="col-sm-9 col-xs-12 pertanyaan wowload fadeInLeft">
        ...
        <form method="post" action='<?=base_url()?>pertanyaan/in/<?=$id?>'>
          <div class="form-group">
            ...
            <?php
              if ($this->session->userdata('hak_akses')==3 ) {
                  echo '<input name="judul" class="form-control" placeholder="Judul ..." type="text">';
              }else{
          ...
          <div class="form-group">
              ...
              <?php
                if ($this->session->userdata('hak_akses')==3 ) {
                  echo '<textarea name="detail" class="form-control" rows="10" placeholder="Detail Pertanyaan ..."></textarea>';
                }else{
