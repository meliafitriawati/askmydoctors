...
<div id="pertanyaan" class="container spacer" style="min-height: 415px;">
  <div class="clearfix">
    ...
    <!-- Diskusi -->
    <div class="col-sm-9 col-xs-12 partners  wowload fadeInLeft">
        <h5 class="judul-tab">Topik Diskusi</h5>
          ...
          <?php
            if ($kategori != null) {
              foreach ($kategori as $key) {
                ...
                if (strlen($myStr)>15) {
                  $myStr = substr($key->nama_spesialisasi, 0, 10) ."...";
                }
                $id = $key->id;
                $url = base_url() ."pertanyaan/daftar/". $id;
                //$ktg = substr($myStr, 0, 20);
                echo "<div class='col-sm-2'>
                        <a href='".$url."' class='thumbnail'>
                          <img class='img-diskusi' style='width: 125px;' src='assets/img/web/spesialisasi_icon/".$key->img_spesialisasi.".jpg' alt='125x125'>
                          <div class='caption'>
                            ".$myStr."
                          </div>
                        </a>
